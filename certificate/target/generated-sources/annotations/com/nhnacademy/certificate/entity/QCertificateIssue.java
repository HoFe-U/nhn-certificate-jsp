...
public class QCertificateIssue extends EntityPathBase<CertificateIssue> {
    ...
    private static final long serialVersionUID = 1309904013L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCertificateIssue certificateIssue = new QCertificateIssue("certificateIssue");

    public final DateTimePath<java.time.LocalDateTime> certificateIssueDate = createDateTime("certificateIssueDate", java.time.LocalDateTime.class);

    public final StringPath certificateTypeCode = createString("certificateTypeCode");

    public final NumberPath<Long> certificationNo = createNumber("certificationNo", Long.class);
