...
public class QFamilyRelationship extends EntityPathBase<FamilyRelationship> {
    ...
    private static final long serialVersionUID = -633190393L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QFamilyRelationship familyRelationship = new QFamilyRelationship("familyRelationship");

    public final StringPath familyRelationCode = createString("familyRelationCode");

    public final com.nhnacademy.certificate.entity.pk.QFamilyRelationShipPk familyRelationShipPk;
    ...
    public QFamilyRelationship(Class<? extends FamilyRelationship> type, PathMetadata metadata, PathInits inits) {
        ...
        this.familyRelationShipPk = inits.isInitialized("familyRelationShipPk") ? new com.nhnacademy.certificate.entity.pk.QFamilyRelationShipPk(forProperty("familyRelationShipPk")) : null;
